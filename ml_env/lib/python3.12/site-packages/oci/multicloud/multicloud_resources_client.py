...
class MulticloudResourcesClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("multicloud_resources", config, signer, multicloud_type_mapping, **base_client_init_kwargs)
    ...
    def list_multicloud_resources(self, subscription_service_name, subscription_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.multicloud.models.MulticloudResourceCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/multicloud/list_multicloud_resources.py.html>`__ to see an example of how to use list_multicloud_resources API.
        """
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/multicloud-omhub-cp/20180828/MulticloudResourceCollection/ListMulticloudResources"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_multicloud_resources got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="MulticloudResourceCollection",
