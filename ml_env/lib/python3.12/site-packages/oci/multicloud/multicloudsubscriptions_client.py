...
class MulticloudsubscriptionsClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("multicloudsubscriptions", config, signer, multicloud_type_mapping, **base_client_init_kwargs)
    ...
    def list_multicloud_subscriptions(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.multicloud.models.MulticloudSubscriptionCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/multicloud/list_multicloud_subscriptions.py.html>`__ to see an example of how to use list_multicloud_subscriptions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/multicloudsubscriptions"
        method = "GET"
        operation_name = "list_multicloud_subscriptions"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/multicloud-omhub-cp/20180828/MulticloudSubscriptionCollection/ListMulticloudSubscriptions"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_multicloud_subscriptions got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="MulticloudSubscriptionCollection",
