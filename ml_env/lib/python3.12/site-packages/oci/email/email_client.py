...
class EmailClient(object):
    ...
    def add_email_domain_lock(self, email_domain_id, add_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/add_email_domain_lock.py.html>`__ to see an example of how to use add_email_domain_lock API.
        """
    ...
    def add_email_ip_pool_lock(self, email_ip_pool_id, add_lock_details, **kwargs):
        """
        Adds a lock to a resource.
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.email.models.EmailIpPool`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/add_email_ip_pool_lock.py.html>`__ to see an example of how to use add_email_ip_pool_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}/actions/addLock"
        method = "POST"
        operation_name = "add_email_ip_pool_lock"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/AddEmailIpPoolLock"
        ...
        if extra_kwargs:
            raise ValueError(
                f"add_email_ip_pool_lock got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "emailIpPoolId": email_ip_pool_id
        }
    ...
    def add_email_outbound_ip(self, add_email_outbound_ip_details, email_ip_pool_id, **kwargs):
        """
        Add OutboundIps to EmailIpPool.


        :param oci.email.models.AddEmailOutboundIpDetails add_email_outbound_ip_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/add_email_outbound_ip.py.html>`__ to see an example of how to use add_email_outbound_ip API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}/actions/addEmailOutboundIp"
        method = "POST"
        operation_name = "add_email_outbound_ip"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/AddEmailOutboundIp"
        ...
        if extra_kwargs:
            raise ValueError(
                f"add_email_outbound_ip got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=add_email_outbound_ip_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def add_return_path_lock(self, email_return_path_id, add_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/add_return_path_lock.py.html>`__ to see an example of how to use add_return_path_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_sender_lock(self, sender_id, add_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/add_sender_lock.py.html>`__ to see an example of how to use add_sender_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_email_domain_compartment(self, email_domain_id, change_email_domain_compartment_details, **kwargs):
        ...
        **Note:** All DKIM objects associated with this email domain will also be moved into the provided compartment.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/change_email_domain_compartment.py.html>`__ to see an example of how to use change_email_domain_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailDomainId']
    ...
    def change_email_ip_pool_compartment(self, email_ip_pool_id, change_email_ip_pool_compartment_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/change_email_ip_pool_compartment.py.html>`__ to see an example of how to use change_email_ip_pool_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}/actions/changeCompartment"
        method = "POST"
        operation_name = "change_email_ip_pool_compartment"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/ChangeEmailIpPoolCompartment"
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_email_ip_pool_compartment got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                body=change_email_ip_pool_compartment_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def change_sender_compartment(self, sender_id, change_sender_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/change_sender_compartment.py.html>`__ to see an example of how to use change_sender_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['senderId']
    ...
    def create_dkim(self, create_dkim_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/create_dkim.py.html>`__ to see an example of how to use create_dkim API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/dkims"
    ...
    def create_email_domain(self, create_email_domain_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/create_email_domain.py.html>`__ to see an example of how to use create_email_domain API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_email_ip_pool(self, create_email_ip_pool_details, **kwargs):
        """
        Creates a new EmailIpPool.


        :param oci.email.models.CreateEmailIpPoolDetails create_email_ip_pool_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/create_email_ip_pool.py.html>`__ to see an example of how to use create_email_ip_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/emailIpPools"
        method = "POST"
        operation_name = "create_email_ip_pool"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/CreateEmailIpPool"
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_email_ip_pool got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_email_ip_pool_details,
                response_type="EmailIpPool",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
    ...
    def create_email_return_path(self, create_email_return_path_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/create_email_return_path.py.html>`__ to see an example of how to use create_email_return_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_sender(self, create_sender_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/create_sender.py.html>`__ to see an example of how to use create_sender API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_suppression(self, create_suppression_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/create_suppression.py.html>`__ to see an example of how to use create_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_dkim(self, dkim_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/delete_dkim.py.html>`__ to see an example of how to use delete_dkim API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_email_domain(self, email_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/delete_email_domain.py.html>`__ to see an example of how to use delete_email_domain API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailDomainId']
    ...
    def delete_email_ip_pool(self, email_ip_pool_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/delete_email_ip_pool.py.html>`__ to see an example of how to use delete_email_ip_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}"
        method = "DELETE"
        operation_name = "delete_email_ip_pool"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/DeleteEmailIpPool"
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_email_ip_pool got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_email_return_path(self, email_return_path_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/delete_email_return_path.py.html>`__ to see an example of how to use delete_email_return_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailReturnPathId']
    ...
    def delete_sender(self, sender_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/delete_sender.py.html>`__ to see an example of how to use delete_sender API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['senderId']
    ...
    def delete_suppression(self, suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/delete_suppression.py.html>`__ to see an example of how to use delete_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_dkim(self, dkim_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_dkim.py.html>`__ to see an example of how to use get_dkim API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dkimId']
        resource_path = "/dkims/{dkimId}"
    ...
    def get_email_configuration(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_email_configuration.py.html>`__ to see an example of how to use get_email_configuration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_email_domain(self, email_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_email_domain.py.html>`__ to see an example of how to use get_email_domain API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailDomainId']
        resource_path = "/emailDomains/{emailDomainId}"
    ...
    def get_email_ip_pool(self, email_ip_pool_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_email_ip_pool.py.html>`__ to see an example of how to use get_email_ip_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}"
        method = "GET"
        operation_name = "get_email_ip_pool"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/GetEmailIpPool"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_email_ip_pool got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_email_return_path(self, email_return_path_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_email_return_path.py.html>`__ to see an example of how to use get_email_return_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailReturnPathId']
        resource_path = "/emailReturnPaths/{emailReturnPathId}"
    ...
    def get_sender(self, sender_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_sender.py.html>`__ to see an example of how to use get_sender API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['senderId']
        resource_path = "/senders/{senderId}"
    ...
    def get_suppression(self, suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_suppression.py.html>`__ to see an example of how to use get_suppression API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['suppressionId']
        resource_path = "/suppressions/{suppressionId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_dkims(self, email_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_dkims.py.html>`__ to see an example of how to use list_dkims API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailDomainId']
        resource_path = "/dkims"
    ...
    def list_email_domains(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_email_domains.py.html>`__ to see an example of how to use list_email_domains API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/emailDomains"
    ...
    def list_email_ip_pools(self, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.email.models.EmailIpPoolCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_email_ip_pools.py.html>`__ to see an example of how to use list_email_ip_pools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/emailIpPools"
        method = "GET"
        operation_name = "list_email_ip_pools"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPoolCollection/ListEmailIpPools"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_email_ip_pools got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="EmailIpPoolCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_email_outbound_ips(self, compartment_id, **kwargs):
        """
        ...
        :param str outbound_ip: (optional)
        ...
        :param str lifecycle_state: (optional)
            ...
            Allowed values are: "UPDATING", "ACTIVE", "FAILED", "DRAINING"

        :param str assignment_state: (optional)
            Filter returned list by specified assignment state.

            Allowed values are: "AVAILABLE", "ASSIGNED"
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.email.models.EmailOutboundIpCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_email_outbound_ips.py.html>`__ to see an example of how to use list_email_outbound_ips API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/emailOutboundIps"
        method = "GET"
        operation_name = "list_email_outbound_ips"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailOutboundIpCollection/ListEmailOutboundIps"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_email_outbound_ips got unknown kwargs: {extra_kwargs!r}")
        ...
        if 'lifecycle_state' in kwargs:
            lifecycle_state_allowed_values = ["UPDATING", "ACTIVE", "FAILED", "DRAINING"]
            if kwargs['lifecycle_state'] not in lifecycle_state_allowed_values:
                raise ValueError(
                    f"Invalid value for `lifecycle_state`, must be one of { lifecycle_state_allowed_values }"
                )

        if 'assignment_state' in kwargs:
            assignment_state_allowed_values = ["AVAILABLE", "ASSIGNED"]
            if kwargs['assignment_state'] not in assignment_state_allowed_values:
                raise ValueError(
                    f"Invalid value for `assignment_state`, must be one of { assignment_state_allowed_values }"
                )

        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["OUTBOUNDIP"]
            if kwargs['sort_by'] not in sort_by_allowed_values:
                raise ValueError(
                    f"Invalid value for `sort_by`, must be one of { sort_by_allowed_values }"
                )
        ...
        query_params = {
            "compartmentId": compartment_id,
            "outboundIp": kwargs.get("outbound_ip", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing),
            "sortOrder": kwargs.get("sort_order", missing),
            "lifecycleState": kwargs.get("lifecycle_state", missing),
            "assignmentState": kwargs.get("assignment_state", missing),
            "sortBy": kwargs.get("sort_by", missing)
        }
        query_params = {k: v for (k, v) in six.iteritems(query_params) if v is not missing and v is not None}
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="EmailOutboundIpCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_email_return_paths(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_email_return_paths.py.html>`__ to see an example of how to use list_email_return_paths API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/emailReturnPaths"
    ...
    def list_senders(self, compartment_id, **kwargs):
        ...
        :param str lifecycle_state: (optional)
            ...
            Allowed values are: "CREATING", "ACTIVE", "NEEDS_ATTENTION", "INACTIVE", "FAILED", "DELETING", "DELETED", "UPDATING"
        ...
        :param str email_ip_pool_id: (optional)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_senders.py.html>`__ to see an example of how to use list_senders API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/senders"
        ...
        if 'lifecycle_state' in kwargs:
            lifecycle_state_allowed_values = ["CREATING", "ACTIVE", "NEEDS_ATTENTION", "INACTIVE", "FAILED", "DELETING", "DELETED", "UPDATING"]
            if kwargs['lifecycle_state'] not in lifecycle_state_allowed_values:
                raise ValueError(
                    f"Invalid value for `lifecycle_state`, must be one of { lifecycle_state_allowed_values }"
                )
        ...
        query_params = {
            ...
            "emailIpPoolId": kwargs.get("email_ip_pool_id", missing),
            "page": kwargs.get("page", missing),
            "limit": kwargs.get("limit", missing),
            "sortBy": kwargs.get("sort_by", missing),
            "sortOrder": kwargs.get("sort_order", missing)
    ...
    def list_suppressions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_suppressions.py.html>`__ to see an example of how to use list_suppressions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/suppressions"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def remove_email_domain_lock(self, email_domain_id, remove_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/remove_email_domain_lock.py.html>`__ to see an example of how to use remove_email_domain_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailDomainId']
    ...
    def remove_email_ip_pool_lock(self, email_ip_pool_id, remove_lock_details, **kwargs):
        """
        Remove a lock to a resource.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/remove_email_ip_pool_lock.py.html>`__ to see an example of how to use remove_email_ip_pool_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}/actions/removeLock"
        method = "POST"
        operation_name = "remove_email_ip_pool_lock"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/RemoveEmailIpPoolLock"
        ...
        if extra_kwargs:
            raise ValueError(
                f"remove_email_ip_pool_lock got unknown kwargs: {extra_kwargs!r}")
    ...
    def remove_email_outbound_ip(self, remove_email_outbound_ip_details, email_ip_pool_id, **kwargs):
        """
        Remove OutboundIps from EmailIpPool.


        :param oci.email.models.RemoveEmailOutboundIpDetails remove_email_outbound_ip_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/remove_email_outbound_ip.py.html>`__ to see an example of how to use remove_email_outbound_ip API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}/actions/removeEmailOutboundIp"
        method = "POST"
        operation_name = "remove_email_outbound_ip"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/RemoveEmailOutboundIp"
        ...
        if extra_kwargs:
            raise ValueError(
                f"remove_email_outbound_ip got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=remove_email_outbound_ip_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def remove_return_path_lock(self, email_return_path_id, remove_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/remove_return_path_lock.py.html>`__ to see an example of how to use remove_return_path_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailReturnPathId']
    ...
    def remove_sender_lock(self, sender_id, remove_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/remove_sender_lock.py.html>`__ to see an example of how to use remove_sender_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['senderId']
    ...
    def update_dkim(self, dkim_id, update_dkim_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/update_dkim.py.html>`__ to see an example of how to use update_dkim API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dkimId']
        resource_path = "/dkims/{dkimId}"
    ...
    def update_email_domain(self, email_domain_id, update_email_domain_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/update_email_domain.py.html>`__ to see an example of how to use update_email_domain API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailDomainId']
        resource_path = "/emailDomains/{emailDomainId}"
    ...
    def update_email_ip_pool(self, email_ip_pool_id, update_email_ip_pool_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/update_email_ip_pool.py.html>`__ to see an example of how to use update_email_ip_pool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailIpPoolId']
        resource_path = "/emailIpPools/{emailIpPoolId}"
        method = "PUT"
        operation_name = "update_email_ip_pool"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/emaildelivery/20170907/EmailIpPool/UpdateEmailIpPool"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_email_ip_pool got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                body=update_email_ip_pool_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def update_email_return_path(self, email_return_path_id, update_email_return_path_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/update_email_return_path.py.html>`__ to see an example of how to use update_email_return_path API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['emailReturnPathId']
        resource_path = "/emailReturnPaths/{emailReturnPathId}"
    ...
    def update_sender(self, sender_id, update_sender_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/email/update_sender.py.html>`__ to see an example of how to use update_sender API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['senderId']
        resource_path = "/senders/{senderId}"
