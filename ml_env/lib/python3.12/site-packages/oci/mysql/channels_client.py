...
class ChannelsClient(object):
    ...
    def generate_channel_status(self, channel_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.mysql.models.ChannelStatus`
        :rtype: :class:`~oci.response.Response`
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['channelId']
        resource_path = "/channels/{channelId}/actions/generateChannelStatus"
        method = "POST"
        operation_name = "generate_channel_status"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/ChannelStatus/GenerateChannelStatus"
        ...
        if extra_kwargs:
            raise ValueError(
                f"generate_channel_status got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_channel_status(self, channel_id, **kwargs):
        """
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['channelId']
        resource_path = "/channels/{channelId}/channelStatus"
        method = "GET"
        operation_name = "get_channel_status"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/ChannelStatus/GetChannelStatus"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_channel_status got unknown kwargs: {extra_kwargs!r}")
