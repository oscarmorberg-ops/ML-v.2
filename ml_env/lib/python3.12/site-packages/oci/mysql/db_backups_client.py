...
class DbBackupsClient(object):
    ...
    def export_backup(self, backup_id, export_backup_details, **kwargs):
        """
        ...
        :param oci.mysql.models.ExportBackupDetails export_backup_details: (required)
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['backupId']
        resource_path = "/backups/{backupId}/actions/export"
        method = "POST"
        operation_name = "export_backup"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/Backup/ExportBackup"
        ...
        if extra_kwargs:
            raise ValueError(
                f"export_backup got unknown kwargs: {extra_kwargs!r}")
