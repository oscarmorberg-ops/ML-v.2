...
class GenerativeAiAgentClient(object):
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
    ...
    def change_agent_compartment(self, agent_id, change_agent_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/change_agent_compartment.py.html>`__ to see an example of how to use change_agent_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_agent_endpoint_compartment(self, agent_endpoint_id, change_agent_endpoint_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/change_agent_endpoint_compartment.py.html>`__ to see an example of how to use change_agent_endpoint_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_knowledge_base_compartment(self, knowledge_base_id, change_knowledge_base_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/change_knowledge_base_compartment.py.html>`__ to see an example of how to use change_knowledge_base_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_provisioned_capacity_compartment(self, provisioned_capacity_id, change_provisioned_capacity_compartment_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/change_provisioned_capacity_compartment.py.html>`__ to see an example of how to use change_provisioned_capacity_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['provisionedCapacityId']
        resource_path = "/provisionedCapacities/{provisionedCapacityId}/actions/changeCompartment"
        method = "POST"
        operation_name = "change_provisioned_capacity_compartment"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-agents/20240531/ProvisionedCapacity/ChangeProvisionedCapacityCompartment"
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_provisioned_capacity_compartment got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "provisionedCapacityId": provisioned_capacity_id
        }
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=change_provisioned_capacity_compartment_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def create_agent(self, create_agent_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_agent.py.html>`__ to see an example of how to use create_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_agent_endpoint(self, create_agent_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_agent_endpoint.py.html>`__ to see an example of how to use create_agent_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_data_ingestion_job(self, create_data_ingestion_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_data_ingestion_job.py.html>`__ to see an example of how to use create_data_ingestion_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_data_source(self, create_data_source_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_data_source.py.html>`__ to see an example of how to use create_data_source API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_knowledge_base(self, create_knowledge_base_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_knowledge_base.py.html>`__ to see an example of how to use create_knowledge_base API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_provisioned_capacity(self, create_provisioned_capacity_details, **kwargs):
        """
        Creates a provisioned capacity.


        :param oci.generative_ai_agent.models.CreateProvisionedCapacityDetails create_provisioned_capacity_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.generative_ai_agent.models.ProvisionedCapacity`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_provisioned_capacity.py.html>`__ to see an example of how to use create_provisioned_capacity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/provisionedCapacities"
        method = "POST"
        operation_name = "create_provisioned_capacity"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-agents/20240531/ProvisionedCapacity/CreateProvisionedCapacity"
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_provisioned_capacity got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_provisioned_capacity_details,
                response_type="ProvisionedCapacity",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def create_tool(self, create_tool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/create_tool.py.html>`__ to see an example of how to use create_tool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/tools"
    ...
    def delete_agent(self, agent_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_agent.py.html>`__ to see an example of how to use delete_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId']
    ...
    def delete_agent_endpoint(self, agent_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_agent_endpoint.py.html>`__ to see an example of how to use delete_agent_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentEndpointId']
    ...
    def delete_data_ingestion_job(self, data_ingestion_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_data_ingestion_job.py.html>`__ to see an example of how to use delete_data_ingestion_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_data_source(self, data_source_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_data_source.py.html>`__ to see an example of how to use delete_data_source API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_knowledge_base(self, knowledge_base_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_knowledge_base.py.html>`__ to see an example of how to use delete_knowledge_base API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['knowledgeBaseId']
    ...
    def delete_provisioned_capacity(self, provisioned_capacity_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_provisioned_capacity.py.html>`__ to see an example of how to use delete_provisioned_capacity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['provisionedCapacityId']
        resource_path = "/provisionedCapacities/{provisionedCapacityId}"
        method = "DELETE"
        operation_name = "delete_provisioned_capacity"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-agents/20240531/ProvisionedCapacity/DeleteProvisionedCapacity"
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_provisioned_capacity got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_tool(self, tool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/delete_tool.py.html>`__ to see an example of how to use delete_tool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_agent(self, agent_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_agent.py.html>`__ to see an example of how to use get_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId']
        resource_path = "/agents/{agentId}"
    ...
    def get_agent_endpoint(self, agent_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_agent_endpoint.py.html>`__ to see an example of how to use get_agent_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentEndpointId']
        resource_path = "/agentEndpoints/{agentEndpointId}"
    ...
    def get_data_ingestion_job(self, data_ingestion_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_data_ingestion_job.py.html>`__ to see an example of how to use get_data_ingestion_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataIngestionJobId']
        resource_path = "/dataIngestionJobs/{dataIngestionJobId}"
    ...
    def get_data_ingestion_job_log_content(self, data_ingestion_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_data_ingestion_job_log_content.py.html>`__ to see an example of how to use get_data_ingestion_job_log_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataIngestionJobId']
    ...
    def get_data_source(self, data_source_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_data_source.py.html>`__ to see an example of how to use get_data_source API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataSourceId']
        resource_path = "/dataSources/{dataSourceId}"
    ...
    def get_knowledge_base(self, knowledge_base_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_knowledge_base.py.html>`__ to see an example of how to use get_knowledge_base API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['knowledgeBaseId']
        resource_path = "/knowledgeBases/{knowledgeBaseId}"
    ...
    def get_provisioned_capacity(self, provisioned_capacity_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_provisioned_capacity.py.html>`__ to see an example of how to use get_provisioned_capacity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['provisionedCapacityId']
        resource_path = "/provisionedCapacities/{provisionedCapacityId}"
        method = "GET"
        operation_name = "get_provisioned_capacity"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-agents/20240531/ProvisionedCapacity/GetProvisionedCapacity"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_provisioned_capacity got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_tool(self, tool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_tool.py.html>`__ to see an example of how to use get_tool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['toolId']
        resource_path = "/tools/{toolId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_agent_endpoints(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_agent_endpoints.py.html>`__ to see an example of how to use list_agent_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/agentEndpoints"
    ...
    def list_agents(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_agents.py.html>`__ to see an example of how to use list_agents API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/agents"
    ...
    def list_data_ingestion_jobs(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_data_ingestion_jobs.py.html>`__ to see an example of how to use list_data_ingestion_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/dataIngestionJobs"
    ...
    def list_data_sources(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_data_sources.py.html>`__ to see an example of how to use list_data_sources API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/dataSources"
    ...
    def list_knowledge_bases(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_knowledge_bases.py.html>`__ to see an example of how to use list_knowledge_bases API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/knowledgeBases"
    ...
    def list_provisioned_capacities(self, **kwargs):
        """
        ...
        :param str provisioned_capacity_id: (optional)
            The `OCID`__ of the provisioned capacity.
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.generative_ai_agent.models.ProvisionedCapacityCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_provisioned_capacities.py.html>`__ to see an example of how to use list_provisioned_capacities API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/provisionedCapacities"
        method = "GET"
        operation_name = "list_provisioned_capacities"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-agents/20240531/ProvisionedCapacity/ListProvisionedCapacities"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_provisioned_capacities got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            "compartmentId": kwargs.get("compartment_id", missing),
            "provisionedCapacityId": kwargs.get("provisioned_capacity_id", missing),
            "lifecycleState": kwargs.get("lifecycle_state", missing),
            "displayName": kwargs.get("display_name", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="ProvisionedCapacityCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_tools(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_tools.py.html>`__ to see an example of how to use list_tools API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/tools"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_agent(self, agent_id, update_agent_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/update_agent.py.html>`__ to see an example of how to use update_agent API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentId']
        resource_path = "/agents/{agentId}"
    ...
    def update_agent_endpoint(self, agent_endpoint_id, update_agent_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/update_agent_endpoint.py.html>`__ to see an example of how to use update_agent_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['agentEndpointId']
        resource_path = "/agentEndpoints/{agentEndpointId}"
    ...
    def update_data_source(self, data_source_id, update_data_source_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/update_data_source.py.html>`__ to see an example of how to use update_data_source API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataSourceId']
        resource_path = "/dataSources/{dataSourceId}"
    ...
    def update_knowledge_base(self, knowledge_base_id, update_knowledge_base_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/update_knowledge_base.py.html>`__ to see an example of how to use update_knowledge_base API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['knowledgeBaseId']
        resource_path = "/knowledgeBases/{knowledgeBaseId}"
    ...
    def update_provisioned_capacity(self, provisioned_capacity_id, update_provisioned_capacity_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/update_provisioned_capacity.py.html>`__ to see an example of how to use update_provisioned_capacity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['provisionedCapacityId']
        resource_path = "/provisionedCapacities/{provisionedCapacityId}"
        method = "PUT"
        operation_name = "update_provisioned_capacity"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-agents/20240531/ProvisionedCapacity/UpdateProvisionedCapacity"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_provisioned_capacity got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_provisioned_capacity_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def update_tool(self, tool_id, update_tool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.167.3/generativeaiagent/update_tool.py.html>`__ to see an example of how to use update_tool API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['toolId']
        resource_path = "/tools/{toolId}"
