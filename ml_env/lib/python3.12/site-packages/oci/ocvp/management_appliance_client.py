...
class ManagementApplianceClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("management_appliance", config, signer, ocvp_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def create_management_appliance(self, create_management_appliance_details, **kwargs):
        """
        Creates a management appliance.


        :param oci.ocvp.models.CreateManagementApplianceDetails create_management_appliance_details: (required)
        ...
        required_arguments = []
        resource_path = "/managementAppliances"
        method = "POST"
        operation_name = "create_management_appliance"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/vmware/20230701/ManagementAppliance/CreateManagementAppliance"
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_management_appliance got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                body=create_management_appliance_details,
    ...
    def delete_management_appliance(self, management_appliance_id, **kwargs):
        """
        Deletes management appliance specified.


        :param str management_appliance_id: (required)
            The `OCID`__ of the management appliance.
        ...
        resource_path = "/managementAppliances/{managementApplianceId}"
        method = "DELETE"
        operation_name = "delete_management_appliance"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/vmware/20230701/ManagementAppliance/DeleteManagementAppliance"
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_management_appliance got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "managementApplianceId": management_appliance_id
        }
    ...
    def get_management_appliance(self, management_appliance_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.ocvp.models.ManagementAppliance`
        :rtype: :class:`~oci.response.Response`
        ...
        resource_path = "/managementAppliances/{managementApplianceId}"
        method = "GET"
        operation_name = "get_management_appliance"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/vmware/20230701/ManagementAppliance/GetManagementAppliance"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_management_appliance got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                response_type="ManagementAppliance",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_management_appliances(self, compartment_id, **kwargs):
        """
        ...
        :param str management_appliance_id: (optional)
            The `OCID`__ of the management appliance.
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.ocvp.models.ManagementApplianceCollection`
        :rtype: :class:`~oci.response.Response`
        ...
        resource_path = "/managementAppliances"
        method = "GET"
        operation_name = "list_management_appliances"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/vmware/20230701/ManagementAppliance/ListManagementAppliances"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_management_appliances got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            "managementApplianceId": kwargs.get("management_appliance_id", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                response_type="ManagementApplianceCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def update_management_appliance(self, management_appliance_id, update_management_appliance_details, **kwargs):
        """
        ...
        :param oci.ocvp.models.UpdateManagementApplianceDetails update_management_appliance_details: (required)
        ...
        resource_path = "/managementAppliances/{managementApplianceId}"
        method = "PUT"
        operation_name = "update_management_appliance"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/vmware/20230701/ManagementAppliance/UpdateManagementAppliance"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_management_appliance got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_management_appliance_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
