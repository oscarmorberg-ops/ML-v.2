...
class CreateVpnAttachmentRequest(RpcRequest):
	...
	def get_TunnelBandwidth(self): # String
		return self.get_query_params().get('TunnelBandwidth')

	def set_TunnelBandwidth(self, TunnelBandwidth):  # String
		self.add_query_param('TunnelBandwidth', TunnelBandwidth)
