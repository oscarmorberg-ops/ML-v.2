...
class DescribeVpcGrantRulesToEcrRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vpc', '2016-04-28', 'DescribeVpcGrantRulesToEcr','vpc')
	...
	def get_EcrInstanceId(self): # String
		return self.get_query_params().get('EcrInstanceId')

	def set_EcrInstanceId(self, EcrInstanceId):  # String
		self.add_query_param('EcrInstanceId', EcrInstanceId)
