...
class CreateVpcRequest(RpcRequest):
	...
	def get_Ipv6CidrMask(self): # Integer
		return self.get_query_params().get('Ipv6CidrMask')

	def set_Ipv6CidrMask(self, Ipv6CidrMask):  # Integer
		self.add_query_param('Ipv6CidrMask', Ipv6CidrMask)
	...
	def get_Ipv6IpamPoolId(self): # String
		return self.get_query_params().get('Ipv6IpamPoolId')

	def set_Ipv6IpamPoolId(self, Ipv6IpamPoolId):  # String
		self.add_query_param('Ipv6IpamPoolId', Ipv6IpamPoolId)
