...
class CreatePhysicalConnectionRequest(RpcRequest):
	...
	def get_OpticalModuleModel(self): # String
		return self.get_query_params().get('OpticalModuleModel')

	def set_OpticalModuleModel(self, OpticalModuleModel):  # String
		self.add_query_param('OpticalModuleModel', OpticalModuleModel)
