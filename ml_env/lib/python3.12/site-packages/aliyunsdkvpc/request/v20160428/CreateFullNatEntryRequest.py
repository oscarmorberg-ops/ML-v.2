...
class CreateFullNatEntryRequest(RpcRequest):
	...
	def get_AccessDomain(self): # String
		return self.get_query_params().get('AccessDomain')

	def set_AccessDomain(self, AccessDomain):  # String
		self.add_query_param('AccessDomain', AccessDomain)
